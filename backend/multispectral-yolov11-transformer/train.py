...
from utils.loss import v11DetectionLoss
...
def train(hyp, opt, device, tb_writer=None):
    ...
    compute_loss = v11DetectionLoss(model)  # init loss class
...
def train_rgb_ir(hyp, opt, device, tb_writer=None):
    ...
    # Process 0
    if rank in [-1, 0]:
        testloader, testdata = create_dataloader_rgb_ir(test_path_rgb, test_path_ir, imgsz_test, batch_size * 2, gs,
                                                        opt,  # testloader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov11n-one_stream.yaml', help='model.yaml path')
